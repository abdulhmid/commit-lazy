...
5. **Breaking Changes**
    ...
    - If included as a footer, a breaking change MUST consist of the uppercase text `BREAKING CHANGE:`, followed by a description, e.g., `BREAKING CHANGE: environment variables now take precedence over config files`.
